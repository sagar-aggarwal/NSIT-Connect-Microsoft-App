#pragma checksum "C:\Users\AGGARWAL'S\documents\visual studio 2015\Projects\NSIT Connect\NSIT Connect\Views\SettingsPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C4B3F63E8461DA33992DB546F4B6BD97"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace NSIT_Connect.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::NSIT_Connect.Views.SettingsPage dataRoot;
            ...
            public void SetDataRoot(global::NSIT_Connect.Views.SettingsPage newDataRoot)
            {
            ...
            private void Update_(global::NSIT_Connect.Views.SettingsPage obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::NSIT_Connect.ViewModels.SettingsPageViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel_SettingsPartViewModel(global::NSIT_Connect.ViewModels.SettingsPartViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 2:
                {
                    this.ViewModel = (global::NSIT_Connect.ViewModels.SettingsPageViewModel)(target);
                }
                break;
            case 3:
                {
